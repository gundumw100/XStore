...
public class ThemeManager {
	...
	public static int BACKGROUNDS[] = { Color.rgb(26, 89, 154), Color.rgb(217, 57, 69), Color.rgb(52, 145, 120),
			...
			Color.rgb(214, 117, 213), Color.rgb(242, 106, 138), Color.rgb(211, 173, 114), Color.rgb(191, 199, 112),
			Color.rgb(120, 213, 214) };
	...
	public int getCurrentColor() {
		return (Integer)SPUtils.get(mContext, KEY, BACKGROUNDS[0]);
	}

	public void saveColor(int index) {
		SPUtils.put(mContext, KEY, BACKGROUNDS[index]);
		notifyThemeChange();
	}
