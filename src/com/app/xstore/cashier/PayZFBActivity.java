...
public class PayZFBActivity extends BaseActivity {
	...
	private final String ZFB_IMAGE_PATH = "ZFB";
	...
	public void updateViews(Object obj) {
		// TODO Auto-generated method stub
		String filePath = (String) SPUtils.get(context, ZFB_IMAGE_PATH, "");
		if (isEmpty(filePath)) {
			...
			btn_ok.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					doCommandSaveBillSale(0,null,null);
				}
			});
		...
		if (requestCode == ImageSelector.IMAGE_REQUEST_CODE) {
			if (data != null) {
				...
				if(!isEmptyList(list)){
					...
					SPUtils.put(context, ZFB_IMAGE_PATH, "file://"+filePath);
					updateViews(null);
				}
